                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <label for="language">{{ __('main.eventdate_start') }}</label>
                                    ...
                                    <br>
                                    <label for="language">{{ __('main.eventdate_end') }}</label>
                                    <input type="date" name="end_date" value="{{ old('end_date') ?? $value->end_date }}" id="end_date" class="form-control form-control-sm @error('end_date') is-invalid @enderror">
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header">
