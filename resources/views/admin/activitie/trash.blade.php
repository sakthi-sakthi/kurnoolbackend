    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="m-0 text-dark">{{ __('main.ActivitiesRecycle') }}</h4>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                            ...
                            <tbody>
                                @foreach ($articles as $article)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.activitie.recover', $article->id) }}"
                                                title="{{ __('main.Recover') }}" class="btn btn-warning btn-xs"><i
                                                    class="fas fa-recycle"></i></a>
                                            <form id="delete_{{ $article->id }}"
                                                action="{{ route('admin.activitie.destroy', $article->id) }}" method="post"
                                                class="d-inline">
                                                @method('DELETE')
                                                @csrf
