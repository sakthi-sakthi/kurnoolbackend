    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="m-0 text-dark">{{ __('main.editreligio') }}</h4>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <div class="content">
            ...
            <div class="container-fluid">
                <form action="{{ route('admin.religio.update',$value->id) }}" method="post" id="form" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-8">
                            ...
                            <div class="card">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-6">
                                            ...
                                            <input type="text"
                                                ...
                                                id="fathername" name="fathername" value="{{ old('fathername') ?? $value->fathername }}">
                                        </div>
                                        <div class="form-group col-6">
                                            <label for="mothername">{{ __('main.mothername') }}</label>
                                            <input type="text"
                                                class="form-control form-control-sm  @error('mothername') is-invalid @enderror"
                                                id="mothername" name="mothername" value="{{ old('mothername') ?? $value->mothername }}">
                                        </div>
                                    <div class="form-group col-6">
                                ...
                                <div class="form-group "> 
                                    ...
                                    <textarea 
                                        ...
                                        id="address" name="address"> {{  $value->address }}</textarea>
