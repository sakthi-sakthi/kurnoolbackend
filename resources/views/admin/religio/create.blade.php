    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="m-0 text-dark">{{ __('main.addreligio') }}</h4>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ __('main.addpriest') }}</li>
                        </ol>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
...
<div class="content">
    <div class="container-fluid"> 
        <form action="{{ route('admin.religio.store') }}" method="post" id="form" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-8">
                    <div class="card">
                      <div class="card-body">
                        {{-- <div class="form-group ">
                            ...
                            <input type="text"
                                ...
                                id="priest_type" name="priest_type" value="{{ old('priest_type') }}">
                        </div> --}}
                        <div class="form-group ">
                ...
                <div class="col-4">
                    ...
                    <div class="card-header">
                     <label for="media_img">{{ __('main.relogioimage') }}</label>
                    </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group col-6">
                                <label for="fathername">{{ __('main.fathername') }}</label>
                                <input type="text"
                                    class="form-control form-control-sm  @error('fathername') is-invalid @enderror"
                                    id="fathername" name="fathername" value="{{ old('fathername') }}">
                            </div>
                            <div class="form-group col-6">
                                <label for="mothername">{{ __('main.mothername') }}</label>
                                <input type="text"
                                    class="form-control form-control-sm  @error('mothername') is-invalid @enderror"
                            ...
                            <div class="form-group col-6">
                                ...
                                <input type="date"
                                    ...
                                    id="feast_day" name="feast_day" value="{{ old('feast_day') }}">
                            </div>
                            <div class="form-group col-6">
                            ...
                            <div class="form-group col-6">
                                ...
                                <input type="text"
                                    ...
                                    id="residence" name="residence" value="{{ old('residence') }}">
                            ...
                            <div class="form-group col-6">
                                ...
                                <input type="text" max="10"
                                    ...
                                    id="ministry" name="ministry" value="{{ old('ministry') }}">
                            </div>
                        </div>
                        <div class="form-group "> 
                ...
                <div class="card" id="save-card">
                    <div class="card-body">
                        <a href="javascript:void(0);" class="btn btn-success btn-sm float-right"
                            ...
                            <a href="{{ route('admin.religio.index') }}" class="btn btn-danger btn-sm float-right mr-2">Cancel</a>
                    </div>
                </div>
            </div>
        </form>
