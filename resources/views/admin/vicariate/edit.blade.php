    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="m-0 text-dark">{{ __('main.editvicariate') }}</h4>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <div class="content">
            ...
            <div class="container-fluid">
                <form action="{{ route('admin.vicariate.update',$value->id) }}" method="post" id="form" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-8">
                        ...
                        <div class="col-4">
                            ...
                            <div class="card-header">
                             <label for="media_img">{{ __('main.priestimage') }}</label>
                                ...
                                <div class="card-body">
                                <img src="{{ $value->getMedia->getUrl('thumb') ?? '' }}" alt=""  id="media_img" class="w-100 mr-5" style="width: 161px !important;">
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="date"
                                            ...
                                            id="establishment_date" name="establishment_date" value="{{ old('establishment_date') ?? $value->establishment_date }}">
                                    </div>
                                    <div class="form-group col-6">
                                        ...
                                        <select class="form-control form-control-sm priest_id" id="priest_id" name="priest_id">
                                            ...
                                            @foreach ($priests as $priest)
                                                <option value="{{ $priest->id }}" @if (old('priest_id') ?? $priest->id == $value->priest_id ) selected @endif>
                                                    {{ $priest->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text"
                                            ...
                                            id="vicarare_forane_mobile" name="vicarare_forane_mobile" value="{{ old('vicarare_forane_mobile') ?? $value->vicarare_forane_mobile }}">
                                    </div>
                                    <div class="form-group col-6">
                                ...
                                <div class="form-group "> 
                                    ...
                                    <textarea 
                                        ...
                                        id="addres" name="address" >{{ old('address') ?? $value->address }}</textarea>
