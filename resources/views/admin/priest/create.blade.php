    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="m-0 text-dark">{{ __('main.addpriest') }}</h4>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
...
<div class="content">
    <div class="container-fluid"> 
        <form action="{{ route('admin.priest.store') }}" method="post" id="form" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-8">
                    <div class="card">
                    ...
                    <div class="card">
                        ...
                        <div class="form-group "> 
                            ...
                            <textarea 
                                ...
                                id="addres" name="address" value="{{ old('address') }}"></textarea>
