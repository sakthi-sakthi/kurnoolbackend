    ...
    <div class="content">
        <div class="container-fluid">
            <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="input-group col-md-6 row">
                                <input type="text" class="form-control form-control-sm" id="map" name="contact[map]" value="{{isset($contact['map'])? $contact['map'] : 'Chennai'}}">
                ...
                <iframe style="width: 100%; height:500px;" id="gmap_canvas" src="https://maps.google.com/maps?q=Chennai&t=&z=15&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
...
@section('script')
<script>
    var map = "{{isset($contact['map'])? $contact['map'] : 'Chennai'}}";
